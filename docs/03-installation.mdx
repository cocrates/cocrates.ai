...
* **@cocrates/cocrates-harness:** 그 무대 위에서 Cocrates만의 특별한 능력을 뽐내는 배우(플러그인)
...
>
> 1. [opencode 터미널](https://opencode.ai/download)을 설치한다.
> 2. [VS Code](https://code.visualstudio.com)를 설치한다.
> 3. OpenChamber 확장을 설치한다 (아래 그림 참조).
>
...
이 파일을 열고 `plugin` 항목에 아래와 같이 슬쩍 추가해 주세요.
...
> 👤 **"[https://cocrates.ai/install.md](pathname:///install.md) 파일을 근거로 Cocrates Harness를 설치해 줘."**
> 
...
3. **치트키 설치법:** 직접 설정하기 귀찮다면 AI에게 "[install.md](pathname:///install.md) 근거로 설치해 줘" 한 문장이면 끝납니다.
