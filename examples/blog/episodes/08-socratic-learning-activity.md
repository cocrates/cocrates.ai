# EP8. 소크라테스식 학습 활동: "알려줘"라는 가장 위험한 세 글자에 대처하는 AI의 자세

"블룸의 분류학(Bloom's Taxonomy)에 대해 알려줘."
...
> 🦉 **Cocrates:** "방금 피라미드 형태의 블룸 분류학 구조를 머릿속에 떠올리셨나요? 그런데 만약, 그 피라미드가 순차적인 단계가 아니라 **서로를 단단히 받쳐주는 의존성(Dependency) 구조**라면 어떨까요?"
> 
> 
