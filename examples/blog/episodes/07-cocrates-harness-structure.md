# EP7. Cocrates Harness 구조: 하나의 거대한 프롬프트가 품을 수 없는 'AI 주방'의 비밀
...
### 1️⃣ Cocrates Agent ([`cocrates.md`](/cocrates.md)) — 공통 원칙과 컨트롤 타워
...
컨트롤 타워 역할을 하는 [`cocrates.md`](/cocrates.md) 파일은 다음과 같은 정교한 6개 섹션으로 빌드업되어 있습니다.
...
| --- | --- |
| 어떤 개념을 기초부터 제대로 배우고 싶다 | `education`<br> |
| 내가 선택지들을 비교하고 결정을 내리고 싶다 | `adr-writing`<br> |
| 명세서를 기반으로 촘촘하게 산출물을 뽑고 싶다 | `spec-driven-generation`<br> |
| 새로운 유형의 문서 작성 워크플로우를 가르치고 싶다 | `generating-skill-creation`<br> |
