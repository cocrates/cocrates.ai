...
- genre-appropriate dialogue density for smartphone reading

**Rule:** Research is read-only input. It must be incorporated into Design artifacts (`overview.md` canvas notes, `world-bible.md`, `characters/*.md`, `locations/*.md`, `episodes/*.md`) in Stage ② — not into Generate prompts alone.
